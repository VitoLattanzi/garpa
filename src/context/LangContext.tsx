...
const translations = {
  es: {
    ...
    error_unknown: 'Ocurrió un error inesperado. Por favor, intentá de nuevo.',
    error_invalid_credentials: 'Email o contraseña incorrectos.',
    error_email_not_confirmed: 'Por favor, confirmá tu email antes de ingresar.',
    error_user_already_registered: 'Ya existe un usuario con este email.',
